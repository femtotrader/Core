...
{
    public class TestIndicatorChandelMomentumOscillator
    {
        private readonly ChandeMomentumOscillator _sut;
        ...
        {
            Util.TestIndicator(_sut, "cmo", new[] { "Result" }, (indicator, results) =>
            {
